...
<template>
  ...
  <pagination style="margin-top: 30px" @updatePage="setSearchPageNum" v-if="searchData && searchPageTotal"
              v-model="searchPageNum" :pageTotal="searchPageTotal"></pagination>
</template>